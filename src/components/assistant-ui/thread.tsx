      ...
      >
        ...
        >
          ...
          <ThreadPrimitive.ViewportFooter
            className={cn(
              "aui-thread-viewport-footer bg-background flex flex-col gap-4 overflow-visible",
              isEmpty
                ? "pb-0"
                : "sticky bottom-0 mt-auto rounded-t-(--composer-radius) pb-4 md:pb-6",
            )}
          >
...
const ThreadWelcome: FC = () => {
  return (
    <div className="aui-thread-welcome-root mb-6 flex flex-col items-center px-4 text-center">
      <h1 className="prompt-title">¿cuál es la próxima aventura?</h1>
    </div>
  );
};
  ...
  return (
    ...
    >
      <ActionBarPrimitive.Edit asChild>
        <TooltipIconButton tooltip="editar" className="aui-user-action-edit">
          <PencilIcon />
        </TooltipIconButton>
